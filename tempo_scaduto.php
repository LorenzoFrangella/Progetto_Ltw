...
<body>
    ...
    <h1 class="titolo animated bounceInDown" style="text-align:center; height:300px">Noooooooo!</h1> <br>
    <br>
    <h2 class="animated zoomIn">Peccato, hai esaurito il tempo a tua disposizione...</h2>  
    <br>
    <p style="color:white;">Torna alla <a href="./index.php">home page </a> per poter fare un altro tentativo.</p>
    <br>
    <br>
    </div>
</body>
